          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th><?= $this->Paginator->sort('voluntario_id') ?></th>
            ...
            <?php foreach ($users as $user): ?>
              <tr>
                ...
                <td><?= $user->has('voluntario') ? $this->Html->link($user->voluntario->id, ['controller' => 'Voluntario', 'action' => 'view', $user->voluntario->id]) : '' ?></td>
                <td><?= $user->has('doador') ? $this->Html->link($user->doador->id, ['controller' => 'Doador', 'action' => 'view', $user->doador->id]) : '' ?></td>
